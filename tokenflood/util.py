...
def get_run_name(date_str: str, task_type: str, name: str, endpoint_spec: EndpointSpec):
    return f"{date_str}_{task_type}_{name}_{endpoint_spec.provider_model_str_as_folder_name}"
