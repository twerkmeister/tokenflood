...
from tokenflood.heuristic import create_prompt, create_prompt_prefix, create_prompt_random_part
from tokenflood.models.heuristic_task import HeuristicTask
from tokenflood.models.token_set import TokenSet


@pytest.mark.parametrize("num_prefix_tokens, expected_result",[
    (4, " A" * 4),
    (0, ""),
    (-10, "")
])
...
def test_create_prompt():
    ...
    assert prompt[prefix_length*2:prefix_length*2+32] != token_set.tokens[0] * 16
