...
from tokenflood.observer import create_even_schedule, create_schedule, run_observation
...
@pytest.mark.parametrize(
    ...
    [(5, 1.0, [0.25, 0.25, 0.25, 0.25]), (4, 1.5, [0.5, 0.5, 0.5]), (1, 2.0, [])],
)
